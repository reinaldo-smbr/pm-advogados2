            ...
            <Swiper {...swiperOptions} className="theme_carousel owl-theme">
                <SwiperSlide className="slide-item">
                    <div className="project-block">
                        <div className="image"><img src="/assets/images/resource/project-1.jpg"  className="w-100" /></div>
                ...
                <SwiperSlide className="slide-item">
                    <div className="project-block">
                        <div className="image"><img src="/assets/images/resource/project-2.jpg"  className="w-100" /></div>
                        <div className="lower-content">
                ...
                <SwiperSlide className="slide-item">
                    <div className="project-block">
                        <div className="image"><img src="/assets/images/resource/project-3.jpg"  className="w-100" /></div>
                        <div className="lower-content">
